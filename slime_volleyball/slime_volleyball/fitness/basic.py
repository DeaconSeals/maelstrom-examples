...
def basic_fitness(
    ...
    **kwargs,
    ...
    results = basic_play_match(env, best_right, best_left, render=True)
    env.reset()
...
def basic_evaluate_matches(
    ...
    for match in matches:
        ...
        reward = basic_play_match(env, right_opp, left_opp)
        env.reset()
